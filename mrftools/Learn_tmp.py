...
###############################
    ...
    def learn(self, weights, max_iter, edge_regularizers, var_regularizers, verbose=False, callback_f=None,  is_feature_graft=False, zero_feature_indices = None):
        ...
        new_weights = ada_grad_1(self.subgrad_obj, self.subgrad_grad, weights, self.zero_feature_indices , None, callback_f)
        ...
        if self.feature_graft:
            ...
            print(gradient_vec)
            # print(max_grad)
            if max_grad > self.l1_regularization:
    ...
    def gradient(self, weights, options=None):
        ...
        for var in self.var_regularizers.keys():
            ...
            print('curr_reg')
            print(curr_reg)
            grad += length_normalizer * self.var_group_regularizers * (curr_reg / np.sqrt(curr_reg.dot(curr_reg))) #IF NORM IS ZERO
