...
def main():
	...
	RES_SHELVE = shelve.open('results_' + str(num_nodes) + '_' + str(edge_reg) + '_' + str(l2) + '.dat')
	...
	if f1[-1] > .4:
		plt.savefig('/home/walidch/mrf_project/' + folder_name + '/' + str(len(variables)) + '/' + str(group_l1) + '/' + str(l2) + '/F1*.eps',linewidth=2.5, format='eps', dpi=1000, bbox_extra_artists=(lgd,), bbox_inches='tight')
	else:
		plt.savefig('/home/walidch/mrf_project/' + folder_name + '/' + str(len(variables)) + '/' + str(group_l1) + '/' + str(l2) + '/F1.eps',linewidth=2.5, format='eps', dpi=1000, bbox_extra_artists=(lgd,), bbox_inches='tight')
	plt.close()
	...
	lgd = ax1.legend(loc='center left', bbox_to_anchor=(1, 0.5))
	plt.savefig('/home/walidch/mrf_project/' + folder_name + '/'+ str(len(variables)) + '/' + str(group_l1) + '/' + str(l2) +'/Recall.eps', format='eps', dpi=1000, bbox_extra_artists=(lgd,), bbox_inches='tight')
	plt.close()
	...
	ax1.set_ylabel('Recall Score')
	lgd = ax1.legend(loc='center left', bbox_to_anchor=(1, 0.5))
	plt.savefig('/home/walidch/mrf_project/' + folder_name + '/'+ str(len(variables)) + '/' + str(group_l1) + '/' + str(l2) +'/IterRecall.eps', format='eps', dpi=1000, bbox_extra_artists=(lgd,), bbox_inches='tight')
	plt.close()
	...
	ax1.set_ylabel('LOSS')
	lgd = ax1.legend(loc='center left', bbox_to_anchor=(1, 0.5))
	plt.savefig('/home/walidch/mrf_project/' + folder_name + '/'+ str(len(variables)) + '/' + str(group_l1) + '/' + str(l2) + '/OBJ.eps', format='eps', dpi=1000, bbox_extra_artists=(lgd,), bbox_inches='tight')
	plt.close()
	...
	plt.savefig('/home/walidch/mrf_project/' + folder_name + '/' +str(len(variables)) + '/' + str(group_l1) + '/' + str(l2) + '/NLL.eps', format='eps', dpi=1000)
	plt.close()
