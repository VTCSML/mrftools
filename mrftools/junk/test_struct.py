...
def main():
	...
	for i in range(len(METHODS)):
		print(METHODS[i])
		if METHODS[i][-1] == ')':
			ax1.plot(M_time_stamps[METHODS[i]], recalls[METHODS[i]], color=METHOD_COLORS[METHODS[i]], linewidth=1, linestyle=':', marker=METHOD_marker[METHODS[i]], markeredgewidth=0.0, label=r'$\alpha = $'+ METHOD_legend[METHODS[i]])
		else:
			ax1.plot(M_time_stamps[METHODS[i]], recalls[METHODS[i]], color=METHOD_COLORS[METHODS[i]], linewidth=1, linestyle=':', marker=METHOD_marker[METHODS[i]], fillstyle='full', markeredgewidth=0.0, label=r'$\alpha = $'+ METHOD_legend[METHODS[i]])
	ax1.set_xlabel('Time')
	...
	for i in range(len(METHODS)):
		...
		if METHODS[i][-1] == ')':
			...
			ax1.plot(recalls[METHODS[i]], color=METHOD_COLORS[METHODS[i]], linewidth=1, linestyle=':', marker=METHOD_marker[METHODS[i]], fillstyle='full', markeredgewidth=0.0, label=r'$\alpha = $'+ METHOD_legend[METHODS[i]])
	ax1.set_xlabel('Iter')
	ax1.set_ylabel('Recall Score')
	lgd = ax1.legend(loc='center left', bbox_to_anchor=(1, 0.5))
