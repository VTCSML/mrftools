    ...
    for var_reg in var_regs:
        for l1_coeff in l1_coeffs:
            for edge_reg in edge_regs:
                ...
                mn_graft, active_space_Graft = mod_priority_graft( variables, num_states, train_data, l1_coeff, l2_coeff, var_reg, edge_reg,  2, .1, max_grafting_iter, max_num_states, verbose)
                print('recall')
