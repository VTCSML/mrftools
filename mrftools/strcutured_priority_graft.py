...
import time
from grafting_util import   initialize_priority_queue, update_grafting_metrics, update_mod_grafting_metrics, setup_learner_1, reset_unary_factors, reset_edge_factors, strcutured_priority_mean_gradient_test
from graph_mining_util import make_graph, select_edge_to_inject
import copy
import operator


def strcutured_priority_graft( variables, num_states, data, l1_coeff, l2_coeff, var_reg, edge_reg, max_iter_graft, max_num_states, verbose):
    """
    ...
    ## GRADIENT TEST
    is_activated_edge, activated_edge, curr_edges_reassigned, curr_graph_edges_reassigned = strcutured_priority_mean_gradient_test(aml_optimize.belief_propagators, search_space, pq, sufficient_stats, data, l1_coeff, 1)
