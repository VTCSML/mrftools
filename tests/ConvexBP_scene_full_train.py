...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--plot_path", default="/Users/youlu/Documents/workspace/mrftools/tests/test_results/ConvexBP_scene_100.jpg", type=str, help="path to save the plot")
