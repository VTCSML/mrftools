...
if __name__ == '__main__':
    ...
    parser.add_argument("-x", "--row_size", default=100, type=int, help="number of rows separated")
    parser.add_argument("-y", "--column_size", default=100, type=int, help="number of columns separated")
