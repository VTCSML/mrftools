...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--plot_path", default="/Users/youlu/Documents/workspace/mrftools/tests/test_results/Inner_dual_horse_100.jpg", type=str, help="path to save the plot")
    ...
    parser.add_argument("-n", "--output_name", default = "Inner_dual_weights", type = str, help="the weights name")
    ...
    FCN_features_train(args.input_dir, "train", args.out_dir, args.size, args.num_class, args.output_name, inference, args.plot_path)
