...
def batch_load_images_features(dir, size, dataset, num_class):
    ...
    IFL = ImageFeatureLoader_scene(max_width=240, max_height=320)
...
def train_model(num_R, num_C, models, labels, num_class, inference_type, plot_path, output_dir):
    ...
    #weights = learner.learn(initial_weights, output_dir, callback=None)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--input_dir", default="/Users/youlu/Documents/PycharmProjects/fcn_8s_pytorch/data/scene", type=str, help="path to the input data")
    parser.add_argument("-o", "--out_dir", default="/Users/youlu/Documents/workspace/mrftools/tests/test_results/scene_FCN/", type=str, help="path to the results")
    parser.add_argument("-p", "--plot_path", default="/Users/youlu/Documents/workspace/mrftools/tests/test_results/ConvexPartialBP_scene_50.jpg", type=str, help="path to save the plot")
    parser.add_argument("-x", "--row_size", default=40, type=int, help="number of rows separated")
    parser.add_argument("-y", "--column_size", default=25, type=int, help="number of columns separated")
    ...
    FCN_features_train(args.input_dir, "valid", args.out_dir, args.size, args.row_size, args.column_size, args.num_class, args.output_name, inference, args.plot_path)
