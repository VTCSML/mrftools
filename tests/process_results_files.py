...
def get_true_objective_values(weights_list, models, labels):
    obj_value_list = list()
...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--input_dir", default="/Users/youlu/Documents/workspace/mrftools/tests/test_results/horse_FCN/cyclic_partialBP_5", type=str, help="path to the weights")
    ...
    parser.add_argument("-a", "--algorithm", default="cyclic_partialBP_5", type=str, help="algorithm name")
    parser.add_argument("-w", "--weight_star", default="/Users/youlu/Documents/workspace/mrftools/tests/test_results/horse_FCN/convexBP/ConvexBP_weights.txt", type=str, help="path to weight star")
    ...
    obj_value_list = get_true_objective_values(all_weights, models, labels)
    output_processed_results(running_time, obj_value_list, args.input_dir, "true_objective_values", args.algorithm)
