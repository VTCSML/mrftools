...
def get_true_objective_values(weights_list, models, labels, interval, running_time, iterations):
    ...
    for i in range(0, len(weights_list)):
        if iterations[i]% interval == 0 or iterations[i] <= 10:
    ...
    for i in range(0, len(new_weights_list)):
        ...
        obj_value = learner.subgrad_obj1(weights)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--input_dir", default="/Users/youlu/Documents/workspace/mrftools/tests/test_results/scene_new_results/pbp_scene_250", type=str, help="path to the weights")
    ...
    parser.add_argument("-a", "--algorithm", default="pbp-250", type=str, help="algorithm name")
    parser.add_argument("-w", "--weight_star", default="/Users/youlu/Documents/workspace/mrftools/tests/test_results/scene_new_results/pbp_scene_50/pbp_scene_weights.txt", type=str, help="path to weight star")
    parser.add_argument("-c", "--num_class", default=9, type=int, help="number of class")
    parser.add_argument("-i", "--interval", default=50, type=int, help="number of class")
    ...
    models, labels, names = batch_load_images_features(args.data_dir, args.size, "valid1", args.num_class)
    new_running_time_list, obj_value_list = get_true_objective_values(all_weights, models, labels, args.interval, running_time, iterations)
